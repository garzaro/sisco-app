...
function Input({
  ...
  return (
    <input
      ...
      // data-slot="input"
      className={cn(
        "file:text-foreground placeholder:text-zinc-700 selection:bg-primary " +
        "selection:text-primary-foreground dark:bg-input/30 border-input h-9 w-72 " +
        ...
        "focus-utils:border-ring focus-utils:ring-ring/50 focus-utils:ring-[3px]",
