...
const navigationMenuTriggerStyle = cva("" +
  "group inline-flex h-9 w-max items-center " +
  "justify-center rounded-md bg-background " +
  "px-4 py-2 text-sm font-medium hover:bg-accent " +
...
function NavigationMenuTrigger({
  ...
  return (
    <NavigationMenuPrimitive.Trigger
      ...
      {children}{" "}
      <ChevronDownIcon
        className="relative top-[1px] ml-7 size-4 transition duration-100 group-data-[state=closed]:rotate-270"
        aria-hidden="true" />
    </NavigationMenuPrimitive.Trigger>
  );
}
